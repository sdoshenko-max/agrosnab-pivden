...
// Надсилає заявки у Telegram-групу "Заявки Агроснаб Південь" (chat_id -4998530969)
// через бот @agrosnab_zayavki_bot. BOT_TOKEN і CHAT_ID — у secrets Worker-a.
// Структурно адаптовано з worker-form.js mltd.com.ua (бот і група інші).
// =====================================================================
