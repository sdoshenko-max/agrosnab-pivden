  ...
  return (
    <>
      ...
      <main className="container-w py-10 max-w-3xl">
        ...
        <p className="mt-8 text-muted text-sm">Документи на конкретний препарат надаємо разом із товаром або на запит — зателефонуйте: <a href="tel:+380770321997" className="text-brand font-semibold">+380 77 032 19 97</a>.</p>
      </main>
      <Footer lang="uk" />
      <FloatingCallButton />
    </>
