      ...
      <main>
        ...
        <section className="container-w py-10 max-w-4xl">
          ...
          <div className="card bg-bg">
            ...
            <p className="text-sm text-muted">ТОВ «АГРОСНАБ-ПІВДЕНЬ»<br />ЄДРПОУ: 35674029<br />Email: sdoshenko@gmail.com<br />Телефон: <a href="tel:+380660321997" className="text-brand">+380 66 032 19 97</a></p>
          </div>
        </section>
      </main>
      <Footer lang="uk" />
