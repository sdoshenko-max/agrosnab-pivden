...
**Джерела фото:** офіційні каталоги Нопосон / Укравіт / Alfa Smart Agro / PEST.UA / Himagro / Нертус. HQ >=800x800, білий фон, без вотермарок, унікальні файли.
**Куди кладемо:** Сайт/public/products/<slug>.jpg (формат jpg, <=200 KB після стиснення).
**Як привязуємо:** у Сайт/lib/products.ts полі image: "/products/<slug>.jpg"

**Статус виконання загальний:** ⏳ 0 / 342 (0%)
...
- [ ] **1.** `spiner-rk-pest-ua` — Спінер, РК | PEST.UA | Гербіцид
- [ ] **2.** `satis-noposon` — САТІС | Нопосон | Гербіцид *(аналог: Пріма)*
- [ ] **3.** `torlayting-noposon` — ТОРЛАЙТІНГ | Нопосон | Гербіцид *(аналог: Євро-Лайтнінг)*
- [ ] **4.** `hepi-star-noposon` — ХЕПІ СТАР | Нопосон | Гербіцид *(аналог: Гранстар)*
- [ ] **5.** `titon-noposon` — ТІТОН | Нопосон | Інсектицид *(аналог: Мілагро)*
- [ ] **6.** `stelium-ultra-tn-alfa-smart-agro` — Стеліум Ультра, ТН | Alfa Smart Agro | Фунгіцид
- [ ] **7.** `hefest-noposon` — ГЕФЕСТ | Нопосон | Гербіцид *(аналог: Раундап)*
- [ ] **8.** `total-rk-himagro` — ТОТАЛ, РК | Himagro | Гербіцид *(аналог: Раундап)*
- [ ] **9.** `hefest-pro-noposon` — ГЕФЕСТ ПРО | Нопосон | Гербіцид *(аналог: Раундап Макс)*
- [ ] **10.** `total-k-vr-himagro` — ТОТАЛ К, ВР | Himagro | Гербіцид *(аналог: Ураган Форте)*

### Пачка 1.2 — позиції 11–20

- [ ] **11.** `dykvat-rk-himagro` — ДИКВАТ, РК | Himagro | Десикант *(аналог: Реглон Супер)*
- [ ] **12.** `mehalyp-pauer-noposon` — МЕГАЛИП ПАУЕР | Нопосон | Інсектицид
- [ ] **13.** `avatar-noposon` — АВАТАР | Нопосон | Інсектицид *(аналог: Харнес)*
- [ ] **14.** `belenus-noposon` — БЕЛЕНУС | Нопосон | Інсектицид *(аналог: Пропоніт)*
- [ ] **15.** `zahrei-noposon` — ЗАГРЕЙ | Нопосон | Інсектицид *(аналог: Примекстра TZ Голд)*
- [ ] **16.** `nirvana-noposon` — НІРВАНА | Нопосон | Інсектицид *(аналог: Нурел Д)*
- [ ] **17.** `akinak-noposon` — АКІНАК | Нопосон | Інсектицид *(аналог: Конфідор + Карате зеон)*
- [ ] **18.** `blok-noposon` — БЛОК | Нопосон | Фунгіцид *(аналог: Фолікур)*
- [ ] **19.** `karbon-noposon` — КАРБОН | Нопосон | Фунгіцид *(аналог: Імпакт)*
- [ ] **20.** `likoris-noposon` — ЛІКОРІС | Нопосон | Фунгіцид *(аналог: Амістар Екстра)*

### Пачка 1.3 — позиції 21–30

- [ ] **21.** `bryhid-noposon` — БРИГІД | Нопосон | Фунгіцид *(аналог: Круізер + Раксіл + Азоксистробін)*
- [ ] **22.** `kait-rk-pest-ua` — Кайт, РК | PEST.UA | Гербіцид
- [ ] **23.** `batman-rk-pest-ua` — Батман, РК | PEST.UA | Гербіцид
- [ ] **24.** `prospero-ks-pest-ua` — Просперо, КС | PEST.UA | Гербіцид
- [ ] **25.** `spiner-ekstra-rk-pest-ua` — Спінер Екстра, РК | PEST.UA | Гербіцид
- [ ] **26.** `berhen-rk-pest-ua` — Берген, РК | PEST.UA | Гербіцид
- [ ] **27.** `stiven-ke-pest-ua` — Стівен, КЕ | PEST.UA | Інсектицид
- [ ] **28.** `lyuter-ke-pest-ua` — Лютер, КЕ | PEST.UA | Інсектицид
- [ ] **29.** `myhel-ks-pest-ua` — Мигель, КС | PEST.UA | Інсектицид
- [ ] **30.** `prahmat-ke-pest-ua` — Прагмат, КЕ | PEST.UA | Інсектицид

### Пачка 1.4 — позиції 31–40

- [ ] **31.** `forynt-ke-pest-ua` — Форинт, КЕ | PEST.UA | Інсектицид
- [ ] **32.** `alberto-tn-pest-ua` — Альберто,ТН | PEST.UA | Інсектицид
- [ ] **33.** `anders-ke-pest-ua` — Андерс, КЕ | PEST.UA | Інсектицид
- [ ] **34.** `lainer-tn-pest-ua` — Лайнер, ТН | PEST.UA | Інсектицид
- [ ] **35.** `punktyr-vh-pest-ua` — Пунктир, ВГ | PEST.UA | Інсектицид
- [ ] **36.** `tronomit-vh-pest-ua` — Трономіт, ВГ | PEST.UA | Інсектицид
- [ ] **37.** `median-tn-pest-ua` — Медіан, ТН | PEST.UA | Фунгіцид
- [ ] **38.** `aperol-ke-pest-ua` — Аперол, КЕ | PEST.UA | Фунгіцид
- [ ] **39.** `heimer-ks-pest-ua` — Геймер, КС | PEST.UA | Фунгіцид
- [ ] **40.** `tetris-pest-ua` — Тетріс | PEST.UA | Фунгіцид

### Пачка 1.5 — позиції 41–50

- [ ] **41.** `meha-dykvat-rk-himagro` — МЕГА ДИКВАТ, РК | Himagro | Десикант
- [ ] **42.** `antymysha-hp-himagro` — АНТИМИША, ГП | Himagro | Інсектицид
- [ ] **43.** `faraon-ke-himagro` — ФАРАОН, КЕ | Himagro | Інсектицид *(аналог: Нурел Д)*
- [ ] **44.** `fostran-ke-himagro` — ФОСТРАН, КЕ | Himagro | Інсектицид *(аналог: Бі-58)*
- [ ] **45.** `nyustar-himagro` — НЬЮСТАР | Himagro | Інсектицид
- [ ] **46.** `operkot-akro-ke-himagro` — ОПЕРКОТ АКРО, КЕ | Himagro | Інсектицид *(аналог: Конфідор+ Карате)*
- [ ] **47.** `zenit-rk-himagro` — ЗЕНІТ, РК | Himagro | Інсектицид *(аналог: Конфідор)*
- [ ] **48.** `taurus-zp-himagro` — ТАУРУС, ЗП | Himagro | Інсектицид *(аналог: Санмайт)*
- [ ] **49.** `rancho-ks-himagro` — РАНЧО, КС | Himagro | Інсектицид *(аналог: Пончо)*
- [ ] **50.** `koloryt-himagro` — КОЛОРИТ | Himagro | Інсектицид

---

## Пачка 2 — SKU 51–100 (50 шт)

**Статус пачки:** ⏳ 0 / 50

### Пачка 2.1 — позиції 51–60

- [ ] **51.** `heksoran-ks-himagro` — ГЕКСОРАН, КС | Himagro | Інсектицид *(аналог: Ніссоран)*
- [ ] **52.** `tebuzan-ultra-tn-himagro` — ТЕБУЗАН УЛЬТРА, ТН | Himagro | Протруйник *(аналог: Раксил Ультра)*
- [ ] **53.** `nominal-ultra-tn-himagro` — НОМІНАЛ УЛЬТРА, ТН | Himagro | Протруйник *(аналог: Круїзер)*
- [ ] **54.** `bimaks-tn-himagro` — БІМАКС, ТН | Himagro | Протруйник
- [ ] **55.** `nitrohen-kvik-rk-himagro` — НІТРОГЕН КВІК, РК | Himagro | Протруйник
- [ ] **56.** `sydhard-tn-himagro` — СИДГАРД, ТН | Himagro | Протруйник *(аналог: Максим 025)*
- [ ] **57.** `triolan-tn-himagro` — ТРІОЛАН, ТН | Himagro | Протруйник
- [ ] **58.** `tiaben-t-tn-himagro` — ТІАБЕН Т, ТН | Himagro | Протруйник
- [ ] **59.** `nitrohen-t-zp-himagro` — НІТРОГЕН Т, ЗП | Himagro | Протруйник
- [ ] **60.** `baktolaiv-sid-zp-himagro` — БАКТОЛАЙВ СІД, ЗП | Himagro | Протруйник

### Пачка 2.2 — позиції 61–70

- [ ] **61.** `prolif-himagro` — ПРОЛІФ | Himagro | Регулятор росту
- [ ] **62.** `stoprost-rk-himagro` — СТОПРОСТ, РК * | Himagro | Регулятор росту
- [ ] **63.** `poliamin-vr-himagro-2` — ПОЛІАМІН, ВР | Himagro | Регулятор росту
- [ ] **64.** `akura-himagro` — АКУРА | Himagro | Регулятор росту
- [ ] **65.** `super-oil-k-himagro` — СУПЕР ОІЛ, К | Himagro | Регулятор росту
- [ ] **66.** `bona-plyus-rk-himagro` — БОНА ПЛЮС, РК | Himagro | Регулятор росту
- [ ] **67.** `bona-supervet-rk-himagro` — БОНА СУПЕРВЕТ, РК | Himagro | Регулятор росту
- [ ] **68.** `laifsul-vh-himagro` — Лайфсул, ВГ | Himagro | Фунгіцид
- [ ] **69.** `doktor-krop-ks-himagro` — ДОКТОР КРОП, КС | Himagro | Фунгіцид *(аналог: Дерозал)*
- [ ] **70.** `tebufor-ke-himagro` — ТЕБУФОР, КЕ | Himagro | Фунгіцид

### Пачка 2.3 — позиції 71–80

- [ ] **71.** `tiofen-himagro` — ТІОФЕН | Himagro | Фунгіцид
- [ ] **72.** `baizafon-zp-himagro` — БАЙЗАФОН, ЗП | Himagro | Фунгіцид *(аналог: Байлетон)*
- [ ] **73.** `atsydan-zp-himagro` — АЦИДАН, ЗП | Himagro | Фунгіцид *(аналог: Ридоміл)*
- [ ] **74.** `fitolikar-ks-himagro` — ФІТОЛІКАР, КС | Himagro | Фунгіцид *(аналог: Імпакт)*
- [ ] **75.** `efatol-zp-himagro` — ЕФАТОЛ, ЗП | Himagro | Фунгіцид *(аналог: Альєт)*
- [ ] **76.** `metakarb-ks-himagro` — МЕТАКАРБ, КС | Himagro | Фунгіцид *(аналог: Дерозал+Ридоміл)*
- [ ] **77.** `fuzaryn-ks-himagro` — ФУЗАРИН, КС | Himagro | Фунгіцид *(аналог: Супрім 400)*
- [ ] **78.** `meteor-zp-himagro` — МЕТЕОР, ЗП | Himagro | Фунгіцид *(аналог: Чемпіон)*
- [ ] **79.** `universal-zp-himagro` — УНІВЕРСАЛ, ЗП | Himagro | Фунгіцид *(аналог: Фолікур)*
- [ ] **80.** `frehat-ks-himagro` — ФРЕГАТ, КС | Himagro | Фунгіцид

### Пачка 2.4 — позиції 81–90

- [ ] **81.** `brodvei-ks-himagro` — БРОДВЕЙ, КС | Himagro | Фунгіцид *(аналог: Квадріс)*
- [ ] **82.** `tiofen-ekstra-zp-himagro` — ТІОФЕН ЕКСТРА, ЗП | Himagro | Фунгіцид *(аналог: Топсин М +Топаз)*
- [ ] **83.** `zhokei-ekstra-ks-himagro` — Жокей Екстра, КС | Himagro | Фунгіцид *(аналог: Амістар Екстра)*
- [ ] **84.** `tonus-ke-himagro` — ТОНУС, КЕ | Himagro | Фунгіцид
- [ ] **85.** `snuker-ks-himagro` — СНУКЕР, КС | Himagro | Фунгіцид *(аналог: Карамба)*
- [ ] **86.** `bredli-himagro` — БРЕДЛІ | Himagro | Фунгіцид
- [ ] **87.** `arhument-rk-nertus` — Аргумент, РК | Нертус | Гербіцид
- [ ] **88.** `terts-rk-nertus` — Терц, РК | Нертус | Інсектицид
- [ ] **89.** `premium-hold-ks-nertus` — Преміум Голд, КС | Нертус | Інсектицид
- [ ] **90.** `herb-900-ke-nertus` — Герб 900, КЕ | Нертус | Інсектицид

### Пачка 2.5 — позиції 91–100

- [ ] **91.** `milafuron-ks-kytai-nertus` — Мілафурон, КС КИТАЙ | Нертус | Інсектицид
- [ ] **92.** `shaman-ke-nertus` — Шаман, КЕ | Нертус | Інсектицид
- [ ] **93.** `fatrin-ke-nertus` — Фатрін КЕ | Нертус | Інсектицид
- [ ] **94.** `milafuron-ks-nertus` — Мілафурон, КС | Нертус | Інсектицид
- [ ] **95.** `fosminii-tabl-nertus` — Фосміній, табл. | Нертус | Інсектицид
- [ ] **96.** `kaizer-nertus` — Кайзер | Нертус | Інсектицид
- [ ] **97.** `sentynel-ke-nertus` — Сентинел КЕ | Нертус | Інсектицид
- [ ] **98.** `hotika-ks-nertus` — Готіка, КС | Нертус | Інсектицид
- [ ] **99.** `kontador-duo-ks-nertus` — Контадор Дуо, КС | Нертус | Інсектицид
- [ ] **100.** `bokser-ks-nertus` — Боксер, КС | Нертус | Інсектицид
